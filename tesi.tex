...
\input{capitoli/capitolo-2}             % Descrizione stage
\input{capitoli/capitolo-3}             % Tecnologie utilizzate
\input{capitoli/capitolo-4}             % Analisi requisiti
\input{capitoli/capitolo-5}             % Progettazione e sviluppo
%\input{capitoli/capitolo-6}            % validazione e verifica
